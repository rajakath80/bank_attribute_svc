    ...
    def test_window_filters_correctly(self):
        ...
        txns = [
            _txn(
                transaction_id="T1",
                amount=-100.0,
                transaction_date=today_proxy - timedelta(days=5),
            ),
            _txn(
                transaction_id="T2",
                amount=-200.0,
                transaction_date=today_proxy - timedelta(days=10),
            ),
            _txn(
                transaction_id="T3",
                amount=500.0,
                transaction_date=today_proxy - timedelta(days=2),
            ),
            _txn(
                transaction_id="T4",
                amount=-50.0,
                transaction_date=today_proxy - timedelta(days=30),
            ),
            _txn(
                transaction_id="T5",
                amount=-80.0,
                transaction_date=today_proxy - timedelta(days=45),
            ),
        ]
    ...
    def test_all_inside_window(self):
        ...
        txns = [
            _txn(
                transaction_id="T1",
                amount=-100.0,
                transaction_date=today_proxy - timedelta(days=1),
            ),
            _txn(
                transaction_id="T2",
                amount=400.0,
